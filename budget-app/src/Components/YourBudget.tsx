...
import calendar from "../assets/budgetImages/calendar.svg";
...
const YourBudget = () => {
  ...
  const [currentCalculatedBudget, setCurrentCalculatedBudget] =
    useState<CalculatedBudget | null>(null);
  const [currentExpenses, setCurrentExpenses] = useState<Expense[] | null>(
    null
  );
  const currentMonthInNumber = getMonth(new Date()) + 1;
  console.log("Current month in number", currentMonthInNumber);
  ...
  return (
    <>
      ...
      <Container>
        {currentMonthInNumber != currentBudget.month ? (
          <>
            <p className="description py-5 text-center">
              <h2 className="mb-3"><b>Nowy miesiąc!</b></h2>
              <b>
                Nie wprowadziłeś jeszcze danych dotyczących budżetu w tym
                miesiącu!
              </b>{" "}
              Możesz to zrobić przechodząc tutaj:{" "}
              <Link to="/addbudgetinfo" className="link">
            ...
            {currentBudget === null ? (
              <>
                <p className="description">
                  Jeśli nie wprowadziłeś jeszcze danych dotyczących budżetu w
                  tym miesiącu możesz to zrobić przechodząc tutaj:{" "}
                  <Link to="/addbudgetinfo" className="link">
                    DODAWANIE BUDŻETU
                  </Link>
                </p>
                        ...
                        <Accordion.Body>
                          {dataset && dataset.length > 0 ? (
                            ...
                            <>
                              <p className="description">
                                {" "}
                                Nie dodałeś jeszcze żadnego wydatku w tym
                                miesiącu.{" "}
                              </p>
                            </>
                          )}
                    ...
                    <Col className="col-md-5">
                      <h5>
                        ...
                        <span className="purple">
                          {currentCalculatedBudget.summary.toFixed(2)} zł
                        </span>
                        ! Trzymaj tak dalej a w skali roku jesteś w stanie
                        oszczędzić{" "}
                        <span className="purple">
                          {(currentCalculatedBudget.summary * 12).toFixed(2)} zł
                        </span>
                        .
                      </h5>
                    </Col>
